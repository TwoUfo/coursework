...
def create_tag_schemas(api):
    ...
    return {
        ...
        "tag_relationship": api.model(
            "TagRelationship",
            {
                "source_tag_name": fields.String(
                    required=True, description="Source tag name"
                ),
                "target_tag_name": fields.String(
                    required=True, description="Target tag name"
                ),
                "weight": fields.Float(
                    required=True, description="Relationship weight (0-1)"
                ),
            },
        ),
    }
...
def create_establishment_schemas(api):
    ...
    return {
        ...
        "establishment_search": api.model(
            "EstablishmentSearch",
            {
